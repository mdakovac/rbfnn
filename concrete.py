...
df.drop_duplicates(subset=df.columns[0:8], inplace=True)
...
excel_data.to_excel('results/concrete/single_std='+str(single_std)+'--random_centers='+str(random_centers)+'.xlsx', sheet_name='sheet1', index=False)
